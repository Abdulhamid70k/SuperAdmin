...
import Profile from '../Subscription/Profile'; // Make sure to import the Profile component

const packageData = [
  {
    CompanyName: 'Kutreya',
    Phonenumber: "8947848287",
    Email: "info@kutreya.com", // Add Email
    Logo: "/path/to/kutreya-logo.png", // Add Logo (path to image)
  ...
  },
  {
    ...
    Phonenumber: "8947848287",
    Email: "contact@cannychoice.com", // Add Email
    Logo: "/path/to/canny-choice-logo.png", // Add Logo (path to image)
            ...
            <table className="w-full table-auto border-collapse">
              ...
              <tbody>
                {packageData.map((packageItem, key) => (
                  <tr
                    key={key}
                    className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-center cursor-pointer"
                    onClick={() => handleSubscriptionClick(packageItem)}
                  >
